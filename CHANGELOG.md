...
- 🎴 GitHub **链接卡片图（Social preview）** 保持**插画版**（`assets/social-1280x640.png`，早期生成的版本）；另新增一套同版式、右侧换成**真实面板截图**的备选版 `assets/social-1280x640-with-shot.png`，由 `tools/make-social-preview.py` 生成（改字/换图重跑即可）。
